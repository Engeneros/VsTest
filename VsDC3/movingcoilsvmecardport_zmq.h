#ifndef MOVINGCOILSVMECARDPORTZMQ_H
#define MOVINGCOILSVMECARDPORTZMQ_H

#include <QHostAddress>
#include "zmq.h"
#include "vmecardbaseport.h"

namespace MovingCoilsVmeCardPort_ZMQ_NS
{
...
class MovingCoilsVmeCardPortZMQ : public VmeCardBasePort
{
public:
    MovingCoilsVmeCardPortZMQ();
    ~MovingCoilsVmeCardPortZMQ();
...
private:
    bool net_talk(MovingCoilsVmeCardPort_ZMQ_NS::DeviceType deviceType, const uint commandCode, const uint deviceID = 0,
...
#endif // MOVINGCOILSVMECARDPORTZMQ_H
